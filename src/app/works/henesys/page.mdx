...
A barebones bookmarking, capture-anything site<sup>1</sup>, inspired by the likes of [Are.na](https://are.na) and [Pinterest](https://pinterest.com). Simple and streamlined, save files, images, URLs or plaintext for future reference. Add notes or tags if you'd like.
